...
Usage: ./run-legofs-io500.sh [OPTIONS]
  ...
  --stage hello|tiny|stress-tiny|rollover-smoke|easy-smoke|hard-smoke|metadata-smoke|small-close-smoke|rnd4k|scc|standard|full22|pressure22
...
case "$STAGE" in hello|tiny|stress-tiny|rollover-smoke|easy-smoke|hard-smoke|metadata-smoke|small-close-smoke|rnd4k|scc|standard|full22|pressure22) ;; *) die "invalid stage: $STAGE" ;; esac
